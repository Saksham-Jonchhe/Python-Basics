...
print(nums)
nums={True,False,1,0,2,3,4}
print(nums)

#Check if a value is in a set
print(2 in nums)

#but you cannot refer to an elemnt in a set with an index position or a key
...
# Keep everything except the duplicates from the two sets
one={1,2,3}
two={2,3,4}
